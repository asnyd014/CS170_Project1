...
class Problem {
        ...
        static int probColumns = 3;
        static int probRows = 3;

        std::vector<int> initialState(probColumns * probRows);
        std::vector<int> goalState(probColumns * probRows);
        algorithm heuristic;

    private:
        void calcHeuristic(SolutionNode& newNode) {
            // Set new node's g(n) to parent's g(n) + 1
            newNode.g_n = newNode.(*parent).g_n + 1; 
        ...
        void blankLeft(SolutionNode& currNode, std::priority_queue& frontier, blankIndex) {
        ...
        void blankRight(SolutionNode& currNode, std::priority_queue& frontier, blankIndex) {
        ...
        void blankUp(SolutionNode& currNode, std::priority_queue& frontier, blankIndex) {
        ...
        void blankDown(SolutionNode& currNode, std::priority_queue& frontier, blankIndex) {
    ...
    public:
        ...
        void expandNode(SolutionNode& currNode, std::priority_queue& frontier) {
